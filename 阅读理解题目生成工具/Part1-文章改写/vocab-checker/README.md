...
基于 2022 版义务教育英语课标二级、三级词汇表（3,585 词条）的 MCP Server，用于检查英文文本中的超纲词汇。
...
├── 二级、三级词汇表（初中毕业要求）.md             # 词表（3,585 词条）
...
`二级、三级词汇表（初中毕业要求）.md` 依据《义务教育英语课程标准（2022年版）》二级、三级词汇要求整理，共收录 **3,585 个词条**（去重 3,581 条，含二级 506 条、常用词组 67 条）；词表中 `*` 标记表示二级（小学阶段）词汇。
