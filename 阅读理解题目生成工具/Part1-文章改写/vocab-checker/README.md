...
基于 2022 版义务教育英语课标二级、三级词汇表（3,686 个可匹配词形）的 MCP Server，用于检查英文文本中的超纲词汇。
...
├── 二级、三级词汇表（初中毕业要求）.md             # 词表（正文 3,570 条 + 附录 86 条）
...
`二级、三级词汇表（初中毕业要求）.md` 依据《义务教育英语课程标准（2022年版）》二级、三级词汇要求整理，实测规模：A–Z 正文 **3,570 条词条**（含二级 505 条）+ 附录 86 条，解析器展开为 **3,686 个可匹配词形**；词表中 `*` 标记表示二级（小学阶段）词汇。